                            ...
                            <form action="{{route('pengusul_pengabdian_update_luaran', [$id, $luaran->usulan_luaran_id])}}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('rencana') is-invalid @enderror" id="rencana" name="rencana" placeholder="Rencana situs publikasi video kegiatan" value="{{$luaran->usulan_luaran_pengabdian_rencana}}">
                                        @error('rencana')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
