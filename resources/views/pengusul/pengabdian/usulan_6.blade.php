                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-footer">
                            <a href="{{route('pengusul_pengabdian_usulan', [5, Request::segment(5)])}}" class="btn btn-danger"><i class="fas fa-arrow-left"></i> Kembali</a>
                            <a href="{{route('pengusul_pengabdian_usulan', [7, Request::segment(5)])}}" class="btn btn-primary ml-auto float-right"><i class="fas fa-arrow-right"></i> Lanjut</a>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
