...
class CreatePkmMitraFileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pkm_mitra_file', function (Blueprint $table) {
            ...
            $table->foreign('mitra_file_mitra_sasaran_id')->references('mitra_sasaran_id')->on('pkm_mitra_sasaran')->onUpdate('cascade')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::table('pkm_mitra_file', function (Blueprint $table) {
            $table->dropForeign('pkm_mitra_file_mitra_file_mitra_sasaran_id_foreign');
        });
        Schema::dropIfExists('pkm_mitra_file');
    }
}
