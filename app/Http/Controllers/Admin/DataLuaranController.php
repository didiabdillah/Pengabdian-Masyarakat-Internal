...
class DataLuaranController extends Controller
{
    public function index()
    {
        ...
        $jenis = Jenis_luaran::join('pkm_kategori_luaran', 'pkm_jenis_luaran.jenis_luaran_kategori_id', '=', 'pkm.kategori_luaran.kategori_luaran_id')->orderBy('pkm_kategori_luaran.kategori_luaran_required', 'desc')->get();
        $status = Status_luaran::join('pkm_kategori_luaran', 'pkm_status_luaran.status_luaran_kategori_id', '=', 'pkm.kategori_luaran.kategori_luaran_id')->orderBy('pkm_kategori_luaran.kategori_luaran_required', 'desc')->get();
